...
**OpenWrt >= 21.02:**
    ...
    wget --no-check-certificate -O /tmp/luci-app-log-viewer_1.2.0-r1_all.ipk https://github.com/gSpotx2f/packages-openwrt/raw/master/current/luci-app-log-viewer_1.2.0-r1_all.ipk
    opkg install /tmp/luci-app-log-viewer_1.2.0-r1_all.ipk
    rm /tmp/luci-app-log-viewer_1.2.0-r1_all.ipk
    service rpcd restart

i18n-ru:

    wget --no-check-certificate -O /tmp/luci-i18n-log-viewer-ru_1.2.0-r1_all.ipk https://github.com/gSpotx2f/packages-openwrt/raw/master/current/luci-i18n-log-viewer-ru_1.2.0-r1_all.ipk
    opkg install /tmp/luci-i18n-log-viewer-ru_1.2.0-r1_all.ipk
    rm /tmp/luci-i18n-log-viewer-ru_1.2.0-r1_all.ipk
